...
export default function FAQ() {
    return (
        <div className="h-[680px] w-screen relative text-white bg-black flex flex-col items-center   ">
            <div className=" flex flex-col items-center gap-2 md:gap-10 w-[300px] md:w-[1000px] absolute top-20 ">
                <h1 className={`${ubuntu.className} text-[18px] md:text-[36px] md:w-[800px] text-center`}>Digital Marketing яагаад чухал вэ?</h1>
            ...
            <div className=" flex flex-col items-center  gap-2 w-[300px] md:w-[1000px] absolute top-70 md:top-90 ">
                <h1 className={`${ubuntu.className} text-[18px]  md:text-[36px] md:w-[1000px] text-center `}>Digital Marketing-ийн чухал болох гол шалтгаанууд</h1>
