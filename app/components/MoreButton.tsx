...
const MoreButton = ({ children, backgroundColor = "#ccff34", ...attributes }: { children: any, backgroundColor?: string }) => {
        ...
        <Magnetic>
            <div className='text-black'>
                <div
                    ...
                    {...attributes}
                >
                    <span className="relative z-10 text-black font-[600] transition-colors duration-300 group-hover:text-black">
                        {children}
                    </span>
